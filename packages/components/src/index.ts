/**
 * Public TypeScript API for @sonapraneeth/components.
 *
 ...
 *   import { activeSocials, type SiteChrome } from '@sonapraneeth/components/chrome';
 */
