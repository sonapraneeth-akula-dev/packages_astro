...
/**
 * Watches the blog content directory and rebuilds the Pagefind search index
 * whenever a post is added, changed, or removed. Used by the dev container so
